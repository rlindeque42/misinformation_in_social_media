...
def comparative():
    ...
    my_file = open("comparative.txt", "r")
    data = my_file.read()
...
for i in range(len(dataset)):
    ...
    feature_dataset.loc[i] = [feature_counter(tweet, swear_words), feature_counter(tweet, first_person), feature_counter(tweet, second_person), feature_counter(tweet, modal), feature_counter(tweet, manner), feature_counter(tweet, superlative), feature_counter(tweet, comparative), feature_counter(tweet, subjective), numbers(tweet),feature_counter(tweet, negations), feature_counter(tweet, divisive), sentiment_vader(tweet), dataset['label'][i]]
